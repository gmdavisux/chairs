...
heroImageAlt: Barcelona Chair and ottoman in a museum display, showing the crossed
  steel frame and tufted leather cushions
heroImageAltStatus: actual
heroImageCaption: Barcelona Chair and ottoman in a museum context. Current source
  is usable but low-resolution for hero display, so AI upscaling/enhancement is recommended
...
- id: structure-detail
  ...
  alt: Front three-quarter view of a Barcelona Chair highlighting the curved X-frame
    structure
  altStatus: actual
...
- id: silhouette-context
  ...
  altStatus: proposed
  caption: Desired silhouette/context image not sourced yet. Placeholder inserted
    for layout review; replace with a verified source image.
  source: TBD
  license: unknown
  origin: placeholder
