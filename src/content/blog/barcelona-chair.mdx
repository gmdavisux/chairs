...
heroImageCaption: Barcelona Chair and ottoman.
heroImageSource: ''
heroImageLicense: ai_generated
heroImageOrigin: null
...
- id: barcelona-chair-context
  ...
  alt: Barcelona Chair in a 1929 International Style interior with warm diffused light and travertine flooring
  altStatus: actual
  caption: Barcelona Chair in its architectural context — warm light, minimal interior
...
- id: barcelona-chair-silhouette
  ...
  alt: Barcelona Chair, profile view capturing distinctive proportions and geometry
  altStatus: actual
...
- id: barcelona-chair-sketch
  ...
  alt: Barcelona Chair, industrial design marker rendering highlighting sculptural form
  altStatus: actual
...
- id: barcelona-chair-designer
  ...
  alt: Ludwig Mies van der Rohe, designer of the Barcelona Chair
  altStatus: actual
  caption: Ludwig Mies van der Rohe
  source: Generated for Classic Furniture Archives
  license: ai_generated
  origin: ai_generated
