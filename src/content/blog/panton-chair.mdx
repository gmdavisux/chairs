...
images:
- id: panton-chair-context
  src: /images/panton-chair-context.png
  alt: Panton Chair — showcased against a mid-century modernist background
  altStatus: actual
  caption: Panton Chair — showcased against a mid-century modernist background.
...
- id: panton-chair-detail-silhouette
  ...
  license: ai_generated
  origin: ai_generated
- id: panton-chair-sketch
  src: /images/panton-chair-sketch.png
  alt: An industiral design style marker rendering of the Panton Chair
  altStatus: actual
  caption: An industiral design style marker rendering of the Panton Chair.
  source: AI generated via google/gemini-imagen
  license: ai_generated
  origin: ai_generated
...
<ImageWithMeta id="panton-chair-context" images={props.entryImages} />
...
<ImageWithMeta id="panton-chair-sketch" images={props.entryImages} />
